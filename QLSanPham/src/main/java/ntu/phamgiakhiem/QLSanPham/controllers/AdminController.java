...
import ntu.phamgiakhiem.QLSanPham.services.CategoryService;
...
public class AdminController {
    ...
    // Hiển thị trang quản trị tổng hợp (Dashboard)
    @GetMapping("/admin")
    public String getAdminDashboard(ModelMap m) {
        // Lấy danh sách sản phẩm và loại sản phẩm để hiển thị
